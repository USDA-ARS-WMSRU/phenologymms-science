!  *********************************************************************
!  *                                                                   *
!  *                S U B R O U T I N E   C A N O P Y H M              *
!  *                                                      de   7/15/05 *
!  *                                                                   *
!  *                                                                   *
!  *********************************************************************
! This subroutine calculates the canopy height of hay millet in two stages.  
! The first stage is from emergence to 8 cm in height within 400 GDD. 
! Growth Stage 2 is from jointing to the start of anthesis.
...
!  OUTPUTS: canht(C,R)
      ...
      subroutine canopyhm(antss, canht, dummy2, ems, gddday, gdde,   
     c joints, maxht)
