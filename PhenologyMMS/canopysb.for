!  *********************************************************************
!  *                                                                   *
!  *                S U B R O U T I N E   C A N O P Y S B              *
!  *                                                      de   7/13/05 *
!  *                                                                   *
!  *                                                                   *
!  *********************************************************************
! This subroutine calculates the canopy height of spring barley in two 
! stages.  The first stage is from emergence to 8 cm in height within 400
! GDD. The second stage is from jointing to the start of anthesis.
...
!  OUTPUTS: canht(C,R)
      ...
      subroutine canopysb(antss, canht, dummy2, ems, gddday, gdde,   
     c joints, maxht)
