!  *********************************************************************
!  *                                                                   *
!  *                S U B R O U T I N E   P H E N O L P M	           *
!  *                                                      de   7/14/05 *
!  *                                                                   *
!  *                                                                   *
!  *********************************************************************
...
!          dav(R), daynum(R), ddae(20)(C), ddap(20)(C), ddav(20)(C),          
!          dgdde(20)(C), dgdds(20)(C), dgddv(20)(C), drs(C,R),
...
!          srs(C,R), tis(C,R), tss(C,R)
      ...
      subroutine phenolpm(aepa, antes, antss, boots, dae, dap,  
...
! All the succeeding stages needed dummy2(2) added to the addition of array positions being added.           
      ...
      elseif ((srs(1) .eq. 999) .and. (gdde .ge. dummy2(2) + 
     c dummy2(3))) then
          srs(1) = daynum
          srs(2) = year
          call date1(srs)
...
!  completed its growth.  
     ...
     1   + dummy2(3) + dummy2(4) + dummy2(5) + dummy2(6) 
     c   + dummy2(7)) )) then
              boots(1) = daynum
              boots(2) = year
              call date1(boots)
...
!  End of anthesis:
     ...
     1  (gdde .ge. (dummy2(2) + dummy2(3) + dummy2(4) + dummy2(5) 
     1  + dummy2(6)  + dummy2(7) + dummy2(8) + dummy2(9) + aepa) )) then
              antes(1) = daynum
              antes(2) = year
              call date1(antes)
	         ddap(12) = dap
