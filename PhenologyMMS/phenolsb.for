!  *********************************************************************
!  *                                                                   *
!  *                S U B R O U T I N E   P H E N O L S B	           *
!  *                                                      de   7/12/05 *
!  *                                                                   *
!  *                                                                   *
!  *********************************************************************
...
!  INPUTS: aepa(C), aifs(C,R), antes(C,R), antss(C,R), boots(C,R),
...
!          srs(C,R), tis(C,R)
      ...
      subroutine phenolsb(aepa, aifs, antes, antss, boots, dae, dap, 
     ...
     c nolvs, pchron, srs, tis, year)
      ...
      integer  aifs(4), antes(4), antss(4), boots(4), dae, dap,  
     c daynum, ddae(20), ddap(20), drs(4), first7, fps(4), 
...
! Time to harvest ripe:
      ...
      elseif ((hrs(1) .eq. 999) .and. (gdde .ge. (dummy2(3) + dummy2(4)
